            ...
            <div className="flex flex-1 flex-col justify-start p-10 bg-white rounded-l-3xl">
                ...
                <div className="flex flex-col mt-10">
                    ...
                    <div className="flex flex-row justify-start items-center rounded-md mt-2 border border-blue-900">
                        ...
                        <input type="text" required className="w-[90%] px-5 py-1 outline-none rounded-r-md my-0 mx-0"/>
                    </div>
                </div>
                ...
                <div className="flex justify-between mt-5">
                    ...
                    <div className="flex flex-row justify-start items-center rounded-md mt-2 border border-blue-900">
                        <input type="text" required className="w-[70%] px-5 py-1 outline-none rounded-r-md my-0 mx-0"/>
                        <div className="w-[30%] flex justify-center items-center bg-sky-200 h-full rounded-l-[5px]">
                            <p>Years</p>
                        </div>
                    </div>    
                    </div>
                    ...
                    <div className="bg-slate-500 flex flex-row justify-start items-center p-[2px] rounded-md mt-2">
                        <input type="text" required className="w-[80%] px-5 py-1 outline-none rounded-l-[3px]"/>
                ...
                <div className="flex flex-col mt-5">
                    <p>Mortgage Type</p>
                    <div className="w-full flex flex-row h-10 justify-start items-center gap-5 p-3 border-[1px] border-slate-500 mt-2 rounded-md">
